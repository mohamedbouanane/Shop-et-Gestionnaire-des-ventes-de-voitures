...
public class MagasinModel {
   ...
   */
  private Map<Integer, VehiculeModel> collectionVehicules;
  ...
  public MagasinModel(
    ...
    Double revenues,
    Double benefice,
    Map<Integer, VehiculeModel> collectionVehicules
  ) {
    this.nom = nom;
  ...
  public Map<Integer, VehiculeModel> getCollectionVehicules() {
